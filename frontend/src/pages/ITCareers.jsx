    ...
    return (
        <div className="min-h-screen bg-[#070b14] pt-32 pb-20 overflow-hidden relative">
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                {/* Filters Row */}
                <div className="max-w-6xl mx-auto mb-12 flex flex-col md:flex-row gap-8 items-center justify-between border-b border-white/5 pb-12">
                    <div className="relative w-full md:w-[450px]">
                        ...
                        <input 
                            ...
                            className="w-full bg-white/5 border border-white/10 rounded-2xl py-5 pl-14 pr-6 text-white focus:outline-none focus:border-blue-500/50 transition-all font-medium"
                        />
                    </div>
                            ...
                            <AnimatePresence mode='popLayout'>
                                {filteredJobs.map((job, idx) => (
                                    <motion.div
                                        ...
                                        className="group p-8 md:p-10 rounded-[2rem] bg-white/5 border border-white/10 hover:border-blue-500/30 transition-all duration-500 hover:bg-white/[0.08] flex flex-col md:flex-row items-start md:items-center justify-between gap-8 relative overflow-hidden"
                                    >
                                        ...
                                        <div className="flex-grow space-y-4">
                                            <div className="flex flex-wrap items-center gap-3">
                                                <span className="px-4 py-1.5 bg-blue-500/10 text-blue-400 text-[10px] font-black uppercase tracking-[.2em] rounded-lg">
                                                    {job.department}
                                                </span>
                                                <span className="px-4 py-1.5 bg-purple-500/10 text-purple-400 text-[10px] font-black uppercase tracking-[.2em] rounded-lg">
                                                    {job.type}
                                                </span>
                                            </div>
                                            <h3 className="text-2xl md:text-3xl font-bold text-white group-hover:text-blue-400 transition-colors" style={{ fontFamily: '"Outfit", sans-serif' }}>
                                                {job.title}
                                            </h3>
                                            <div className="flex flex-wrap items-center gap-8 pt-2">
                                                ...
                                                <div className="flex items-center gap-2 text-gray-500 text-sm font-medium">
                                                    <Clock size={16} className="text-purple-500" /> Full-Time
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-center gap-4 w-full md:w-auto mt-4 md:mt-0">
                                            <button 
                                                ...
                                                className="flex-grow md:flex-grow-0 px-10 py-5 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold rounded-2xl uppercase tracking-widest text-[11px] shadow-lg shadow-blue-500/20 hover:scale-105 active:scale-95 transition-all group-hover:shadow-blue-500/40 flex items-center justify-center gap-3"
                                            >
