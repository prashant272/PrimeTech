...
const products = [
    {
        ...
        fullDesc: 'Bulk SMS is one of the most effective ways to reach your customers directly. Our Promotional SMS service helps you reach thousands of potential customers in a single click with high delivery rates.',
        detailedInfo: 'In recent times, Promotional SMS Services have gained massive popularity. These are highly effective and used by various companies, firms, and NGOs.\n\nPromotional SMS services are offered by various firms, but we stand out by providing a reliable and cost-effective platform. Our gateway is optimized for high-speed delivery, ensuring your marketing messages reach users at the right time.\n\nWhether you are a startup or an established enterprise, our promotional SMS platform provides the tools you need to create, manage, and track your campaigns with ease.',
        whyChooseUs: ['98% Open rate within minutes of delivery.', 'Targeted marketing to reach the right audience.', 'Cost-effective solution with massive ROI potential.', 'Direct reach without internet dependency.', 'Real-time tracking and delivery reports.'],
        features: [
    ...
    },
    {
        ...
        whyChooseUs: ['Sub-5 second delivery for critical alerts.', '24/7 Priority routing through dedicated gateways.', 'Full compliance with DLT standards.', 'Automatic failover for zero message loss.', 'Detailed logs for every transaction.'],
        features: [
    ...
    },
    {
        ...
        whyChooseUs: ['Highest delivery success ratio.', 'Low-latency gateway for instant delivery.', 'Global coverage across all major networks.', 'Advanced anti-fraud protection.', 'Easy backend tech integration.'],
        features: [
    ...
    },
    {
        ...
        whyChooseUs: ['Branded and verified profiles for trust.', 'Interactive messaging with clickable buttons.', 'Rich media: video, audio, and documents.', 'Deep analytics with interaction tracking.', 'Fallback to standard SMS for 100% reach.'],
        features: [
    ...
    },
    {
        ...
        whyChooseUs: ['Strategic planning for campaign ROI.', 'Advanced user segmentation tools.', 'High-volume throughput capacity.', 'Detailed performance analytics.', 'Dedicated success manager support.'],
        features: [
    ...
    },
    {
        ...
        whyChooseUs: ['Targeted outreach based on constituency data.', 'Voice calls in candidates\' own voice for personal touch.', 'Zero-latency delivery for urgent manifesto updates.', 'Massive scale: reach millions of voters simultaneously.', 'Full regulatory and legal compliance for campaigning.'],
        features: [
    ...
    },
    {
        ...
        detailedInfo: 'Real estate is all about the right timing and the right buyer. Our specialized Real-Estate Campaign service helps developers and brokers reach potential investors with high-quality brochures, site-visit invites, and price alerts.',
        whyChooseUs: ['High-quality lead generation through targeted SMS.', 'Interactive WhatsApp profiles for property catalogs.', 'Automatic site-visit reminders for potential buyers.', 'Deep analytics to track buyer interest and clicks.', 'Direct connect: Instant callback for interested leads.'],
        features: [
    ...
    },
    {
        ...
        whyChooseUs: ['Natural human touch with professional audio.', 'Reach users without smartphone/internet.', 'Automated retry for unanswered calls.', 'Capture input via DTMF keypad interactions.', 'Detailed call duration and engagement reports.'],
        features: [
            ...
            { title: 'Global', desc: 'Call across any network.', icon: 'Globe' },
    ...
    },
    {
        ...
        whyChooseUs: ['Convert passive listeners into active participants.', 'Instant lead qualification through numeric input.', 'Detailed logs of every keypress for analysis.', 'Scalable: handles thousands of responses simultaneously.', 'Easy integration with webhooks and databases.'],
        features: [
    ...
    },
    {
        ...
        whyChooseUs: ['Instant lead response: connect in < 30 seconds.', 'Zero friction for users—no typing, just talking.', 'Record and monitor every sales interaction.', 'Increase website conversion by up to 40%.', 'Time-restricted calling to match office hours.'],
        features: [
    ...
    },
    {
        ...
        whyChooseUs: ['Extremely high delivery success compared to SMS.', 'Safe from SMS-spoofing and phishing attacks.', 'Supports landlines and people with vision impairment.', 'Global reach on any telephony network.', 'Customizable voice (Human or synthesized AI).'],
        features: [
    ...
    },
    {
        ...
        whyChooseUs: ['Enterprise-level corporate image for small startups.', '24/7 Automated customer self-service.', 'Reduce staff workload with automated routing.', 'Real-time call data and missed call alerts.', 'Scalable: upgrade flows as your business grows.'],
        features: [
    ...
    },
    {
        ...
        whyChooseUs: ['Zero cost for users—massive engagement rates.', 'Instant lead generation: capture number on dial.', 'Automatic SMS confirmation for every call.', 'Unlimited concurrent calls: no busy lines.', 'User-friendly panel for verification and data.'],
        features: [
        ...
        process: [
            ...
            { title: 'Rule Set', desc: 'Define what happens after the call.' },
    ...
    },
    {
        ...
        whyChooseUs: ['Easy to remember 5-digit short codes for branding.', 'Affordable 10-digit long codes for global use.', 'Keyword-based routing for different departments.', 'High-volume capacity for interactive campaigns.', 'Real-time automated responses to user queries.'],
        features: [
    ...
    },
    {
        ...
        whyChooseUs: ['Official Green Badge verification support.', 'Connect with 2 billion+ users globally.', 'High delivery and open rates (up to 98%).', 'Full end-to-end encryption for security.', 'Developer-friendly REST API for any platform.'],
        features: [
    ...
    },
    {
        ...
        whyChooseUs: ['Verified Green Badge for brand trust.', 'High reply rates and two-way chat.', 'End-to-end encrypted messaging.', 'Rich catalog and payment integrations.', 'AI chatbots for 24/7 support.'],
        features: [
    ...
    },
    {
        ...
        whyChooseUs: ['Reduce support ticket volume by up to 80%.', 'Instant responses for higher customer satisfaction.', 'Multi-lingual support for global audiences.', 'Easy no-code bot builder interface.', 'Seamless handover to human agents if needed.'],
        features: [
    ...
    },
    {
        ...
        whyChooseUs: ['Targeted broadcasting to opt-in lists.', 'Rich media Support: Video, PDF, and Carousels.', 'Interactive buttons for one-click conversion.', 'Real-time read and click tracking analytics.', 'A/B testing for message optimization.'],
        features: [
    ...
    },
    {
        ...
        whyChooseUs: ['Real-time live tracking with < 10 second refresh.', 'Precision geofencing and instant entry/exit alerts.', 'Detailed fuel consumption and speed limit reports.', 'Historical route playback up to 90 days.', 'Mobile app support with SOS and anti-theft alerts.'],
        features: [
    ...
    },
    {
        ...
        whyChooseUs: ['Automated load and route optimization.', 'Digital LR (Lorry Receipt) and billing management.', 'Integrated driver mobile app for delivery proof.', 'Real-time transit tracking and customer alerts.', 'Detailed profit/loss analysis per trip.'],
        features: [
    ...
    },
    {
        ...
        whyChooseUs: ['Automated membership renewal SMS alerts.', 'Integrated biometric and RFID attendance.', 'Secure online payment and POS support.', 'Instructor and personal trainer schedule manager.', 'Member mobile app for workout tracking.'],
        features: [
    ...
    },
    {
        ...
        whyChooseUs: ['SEO-optimized, lightning-fast store frontend.', 'Multi-currency and global payment support.', 'Advanced inventory and warehouse tracking.', 'Built-in abandoned cart recovery tools.', 'Rich analytics for sales and customer behavior.'],
        features: [
            { title: 'Catalog Pro', desc: 'Manage thousands of SKUs easily.', icon: 'Layout' },
            { title: 'Payments', desc: 'Secure Razorpay/PayU integration.', icon: 'Shield' },
    ...
    },
    {
        ...
        whyChooseUs: ['Automated attendance and timetable management.', 'Secure and easy online fee collection gateway.', 'Instant exam result processing and report generation.', 'Dedicated parent-teacher mobile app integration.', 'Robust student behavior and academic tracking.'],
        features: [
    ...
    },
    {
        ...
        whyChooseUs: ['Secure EMR (Electronic Medical Records) storage.', 'Integrated laboratory and pharmacy modules.', 'Efficient OPD/IPD appointment management.', 'Real-time inventory and medicine tracking.', 'Detailed financial and surgical performance logs.'],
        features: [
    ...
    },
    {
        ...
        whyChooseUs: ['Biometric and Geo-fencing attendance support.', 'One-click automated payroll and tax calculation.', 'Transparent performance and KPI tracking.', 'Employee self-service (ESS) portal for leaves.', 'Secure document vault for employee files.'],
        features: [
...
const seed = async () => {
    try {
        ...
        console.log(`\n🎉 Done! ${added} products seeded to database.`);
