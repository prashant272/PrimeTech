...
const visas = [
    ...
    },
    {
        ...
        features: [
            ...
            { title: 'Health Guide', desc: 'Assistance with medical requirements.', icon: 'HeartPulse' },
    ...
    },
    {
        ...
        bgImage: 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?auto=format&fit=crop&w=1950&q=80',
    ...
    },
    {
        ...
        features: [
            ...
            { title: 'Itinerary Plan', desc: 'Custom holiday planning included.', icon: 'Map' },
    ...
    },
    {
        ...
        features: [
            ...
            { title: 'Secure', desc: 'Safe handling of sensitive documents.', icon: 'Lock' }
        ],
        active: true
    },
    {
        ...
        features: [
            ...
            { title: 'Entry Flex', desc: 'Valid for major international airports.', icon: 'Plane' },
...
const seed = async () => {
    try {
        ...
        for (const visa of visas) {
            ...
            console.log(`✅ Upserted: ${visa.title}`);
            count++;
        }
        console.log(`\n🎉 Done! ${count} visas seeded.`);
